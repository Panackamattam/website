...
$sql = "INSERT INTO telecalling(fname, lname, gender, firmname, add1, add2, city, state, postcode, phone, mobile, email, reff, tstatus, asigned, sdate, crdate, crby) VALUES ('$fname','$lname','$gen','$bname','$add1','$add2','$city','$state','$pin','$phone','$mobile','$email','$re','$st','$re','$cdate','$cdate','$user')";
