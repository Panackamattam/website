...
<div class="card">
<div class="card-body">
				<h4 class="card-title"><strong>Update Pending tickets</strong></h4>
...
?>
<tr>
<td><a href="updateticket.php?comid=<?php echo $row2["compid"] ?>&search=search"><?php echo $row2["compid"] ?></a></td>
