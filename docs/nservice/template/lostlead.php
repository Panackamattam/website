...
<div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
				...
				<h4 class="card-title"><strong>Leads</strong></h4>
...
<h4><strong>Lost Leads Details</strong></h4>
...
<?php
$ledid = $row2["lid"];
$qry10 = "select * from leadremark where leadid='$ledid' order by id desc limit 1";
$qryres = $con->query($qry10);
$row10 = $qryres->fetch_assoc();
$bamt = $row10["leadremark"];
?>
<td><?php echo $bamt?></td>
</tr>
<?php
