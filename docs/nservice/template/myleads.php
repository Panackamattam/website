...
{
$sql2 = "select * from leads where status='$st1' order by id desc";
}
...
<p><button type="button" class="btn btn-inverse-primary btn-fw"><a href="addcall.php">Add Telecalling</a></button>&nbsp;&nbsp;&nbsp;
