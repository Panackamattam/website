...
$in = $row4["invno"];
$sql21 = "SELECT * FROM invoice WHERE invno='$in' and status='$st'";
//echo $sql3;
$cgst = "0";
$sgst = "0";
...
$sq0 = "update invdetails set totalamt='$gts', cgst='$cgst', sgst='$sgst', cess='$cess', gst='$tgst' where invno='$in'";
if(mysqli_query($con, $sq0 )){
			// echo "Records added successfully.";
			} else{
		// echo "ERROR: Could not able to execute $upparts. " . mysqli_error($con);
			}

$sq9 = "update Complaints set invno='$in' where compid='$comid'";
if(mysqli_query($con, $sq9 )){
			// echo "Records added successfully.";
			} else{
		// echo "ERROR: Could not able to execute $upparts. " . mysqli_error($con);
			}
...
$to = $cemail;
$subject = "Invoice of your complaint";
...
$sql6 = "select * from invoice where invno='$in'";
...
$to = $qryrow11["email"];
$subject = "Invoice of complaint | Please collect payment";
