...
?>
        ...
        <div class="main-panel">
          <div class="content-wrapper pb-0">
			...
			$sql1 = "select * from gstcustomers where cname='$acc' and status='$st'";
			$result = $con->query($sql1);
			$row = $result->fetch_assoc();
			$comid = $row["cid"];
			
			$sql = "INSERT INTO gstpayment(comid, cname, voucherno, vdate, account, bankcash, amount, remark, status, crby, crdate, transtype,crdr) VALUES ('$comid','$acc','$vid','$vdate','$acc','$bc','$amt','$rem','$st','$user','$cdate','$ttype','$crdr')";
			...
			{
			$csql = "INSERT INTO bankbook(date, transaction, amount, crdr, status,crby,crdate) VALUES ('$cdate','$rem','$amt','$crdr','$st','$cdate','$user')";
		  ...
		  <div class="col-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Receipt Entry <?php if ($msg) { echo "-".$msg; }?></h4>
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
							  ...
							  <input type="hidden" name="ttype" value="Receipt" class="form-control" />
                            </div>
                          </div>
                        </div>
                        <div class="col-md-6">
