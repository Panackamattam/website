...
<div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
				...
				<h4 class="card-title"><strong>Request parts for tickets</strong></h4>
...
?>
<tr>
<td><a href="requestpart.php?comid=<?php echo $row2["compid"] ?>&search=search"><?php echo $row2["compid"] ?></a></td>
