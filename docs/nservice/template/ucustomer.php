...
?>
  ...
  <div class="col-12 grid-margin">
    ...
    <h4 class="card-title"><strong>Sucessfully Updated Customer Details</strong></h4>
<table class="table">
<tr>
<td width="20%"><strong>Customer ID</td><td width="35%"><?php echo $cd ?></td>
<td width="16%"><strong></td><td width="35%"></td>
</tr>
<tr>
