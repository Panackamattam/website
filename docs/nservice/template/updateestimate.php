...
<input type="hidden" name="uestimate" value="Send Revised Estimate to the Customer"></input><button type="submit" class="btn btn-primary mr-2">Send Estimate to Customer</button></td>
</tr>
</form>
</table>
<?php
