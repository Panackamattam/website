...
<tr>
<td colspan="4" align="center"><input type="hidden" name="comid" value="<?php echo $comid ?>"></input><input type="submit" name="sestimate" value="Send Estimate to Customer" class="w3-button w3-green w3-third"></input></td>
</tr>
</form>
</table>
<?php
