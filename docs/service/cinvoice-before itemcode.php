...
$invno = ($idrow["invno"] + 1);
$insql = "INSERT INTO invdetails(invno, invdate, compid, cid, cname, mobile, email, invamount, paystatus, crby, crdate, status) VALUES ('$invno', '$cdate', '$comid', '$cid', '$cname', '$mobile', '$email', '$z', '$z', '$user', '$cdate', '$st')";
...
$ipsql = "INSERT INTO invoice(invno, invdate, parts, qty, rate, total, compid, cid, status, crby, crdate, mdby, mddate, cgst, sgst, gst) VALUES ('$invno', '$cdate', '$part', '$qt', '$srate', '$tot', '$comid', '$cid', '$st', '$user', '$cdate', '$z', '$cdate', '$cgst', '$sgst', '$gst')";
//echo $ipsql;
...
$sql7 = "INSERT INTO invoice(invno, invdate, parts, qty, rate, total, compid, cid, status, crby, crdate, mdby, mddate, cgst, sgst, gst) VALUES ('$invno', '$cdate', '$part', '$qt', '$srate', '$tot', '$comid', '$cid', '$st', '$user', '$cdate', '$z', '$cdate', '$cgst', '$sgst', '$gst')";
