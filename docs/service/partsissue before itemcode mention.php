...
if ($sub) {
	...
	$issued = "Issued";
		...
		$upparts = "update parts set issuedqty='$rqty', sellingrate='$srate', issuedby='$user', issueddate='$cdate', pstatus='$issued' where srno='$srno'";
		//echo $upparts;
		...
		// echo "ERROR: Could not able to execute $upsql. " . mysqli_error($con);
			...
			$upparts = "update parts set issuedqty='$issuedqty', sellingrate='$srate', issuedby='$user', issueddate='$cdate', pstatus='$issued' where srno='$srno'";
			if(mysqli_query($con, $upparts )){
			// echo "Records added successfully.";
			} else{
		// echo "ERROR: Could not able to execute $upsql. " . mysqli_error($con);
