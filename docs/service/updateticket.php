...
$st = "Resolved";
	if ($role == "technician") {
$sql = "SELECT * FROM Complaints where cstatus!='$st' and asained='$user' order by compid";
}
	if ($role == "Admin") {
...
<tr>
<td colspan="4" align="center"><input type="submit" name="update" Value="Update"></input></td>
</tr>
